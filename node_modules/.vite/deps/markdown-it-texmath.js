...
var require_texmath = __commonJS({
  "node_modules/markdown-it-texmath/texmath.js"(exports, module) {
    ...
    function texmath(md, options) {
      ...
      if (!texmath.katex) {
        if (options && typeof options.engine === "object") {
          ...
          texmath.katex = require_katex();
        else
          texmath.katex = { renderToString() {
...
export default require_texmath();
//# sourceMappingURL=markdown-it-texmath.js.map
