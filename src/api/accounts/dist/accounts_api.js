...
var AccountsApi = /** @class */ (function () {
    ...
    AccountsApi.getAccountBriefList = function (id_list) {
        return __awaiter(this, void 0, Promise, function () {
            var url, response, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = makeUrl('/get-brief-list');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    AccountsApi.getAccountProfile = function (user_id) {
        return __awaiter(this, void 0, Promise, function () {
            var url, response, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = makeUrl('/profile/' + user_id.toString());
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
