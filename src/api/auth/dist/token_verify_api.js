...
exports.resetTokenExpirations = exports.DeleteUserToken = exports.VerifyUserToken = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, api_1["default"].post("/auth/token/verify/login", null, {
    ...
    return __awaiter(this, void 0, Promise, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, api_1["default"].post("auth/token/delete", null, {
                            withCredentials: true,
                            params: {
                                lang: store_1.getPreferedLangCode()
                            }
                ...
                case 1:
                    response = _a.sent();
                    store_2["default"].commit("LogoutUser"); // remove the user info from the store
                    return [2 /*return*/, Promise.resolve(response)];
                case 2:
                    error_3 = _a.sent();
...
// TODO: refresh token expirations in backend
/**
 ...
 * @returns {any}
 */
function resetTokenExpirations() {
    return __awaiter(this, void 0, void 0, function () {
...
exports.resetTokenExpirations = resetTokenExpirations;
