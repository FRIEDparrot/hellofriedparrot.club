...
var LoginApi = /** @class */ (function () {
     ...
     */
    LoginApi.loginUserByPassword = function (login_form_data) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                params = { method: 'password' };
                return [2 /*return*/, api_1.ResponseHandler(function () {
                        return api_1.postRequestWithCredentials('auth/login/', login_form_data, params);
                    })];
            });
        });
    };
     ...
     *         - failed  : error { error_code,  message }
     */
    LoginApi.loginUserByCaptcha = function (login_form_data) {
        return __awaiter(this, void 0, void 0, function () {
            var params;
            return __generator(this, function (_a) {
                params = { method: 'captcha' };
                return [2 /*return*/, api_1.postRequestWithCredentials('auth/login/', login_form_data, params)];
            });
        });
    };
    return LoginApi;
