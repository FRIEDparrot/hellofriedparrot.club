...
var HistoryApi = /** @class */ (function () {
     ...
     */
    HistoryApi.addHistoryRecord = function (data) {
     ...
     */
    HistoryApi.getHistoryRecords = function () {
        return __awaiter(this, void 0, Promise, function () {
     ...
     */
    HistoryApi.deleteAllHistory = function () {
        return __awaiter(this, void 0, Promise, function () {
            var url, response, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = makeUrl('/delete_all');
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.deleteRequestWithCredentials(url)];
                    case 2:
                        response = _a.sent();
                        return [2 /*return*/, Promise.resolve(response)];
                    case 3:
