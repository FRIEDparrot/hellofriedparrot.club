...
var DraftsApi = /** @class */ (function () {
     ...
     */
    DraftsApi.getUserDraftList = function (params) {
        return __awaiter(this, void 0, Promise, function () {
            var url, param_request, response, data, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        url = makeUrl('/getlist-user');
                        param_request = stdDataTableServer_1.makeStdDataTableRequestParams(params);
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.postRequestWithCredentials(url, param_request)];
                    case 2:
                        response = _a.sent();
                        data = response.data;
    ...
    DraftsApi.getUserDraftContent = function (uuid) {
        return __awaiter(this, void 0, Promise, function () {
    ...
    DraftsApi.deleteUserDraft = function (uuid) {
    ...
    DraftsApi.saveBlogDraft = function (data, uuid) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, api_1.postRequestWithCredentials(url, data, {
                                uuid: uuid
                            })];
                    case 2:
                        response = _a.sent();
    ...
    DraftsApi.publishBlogDraft = function (data, uuid) {
        return __awaiter(this, void 0, void 0, function () {
