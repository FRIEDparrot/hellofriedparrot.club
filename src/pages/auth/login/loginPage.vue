<template>
  <SidebarLayout>
    ...
    <template v-slot:main-content>
      ...
      <v-card max-width="400" class="mx-auto mt-8" elevation="12">
        <v-tabs v-model="tab" bg-color="#493545" grow :disabled="isLoading">
          ...
          <v-tabs-window-item value="email_login">
            <v-card-text>
              <v-form @submit.prevent="submitLoginByEmail">
                ...
                <v-card-actions>
                  <v-btn class="text-white bg-grey" width="100px">
                    {{ $t('login.CancelBtn') }}
                  </v-btn>
                  <v-spacer></v-spacer>
                  <v-btn
