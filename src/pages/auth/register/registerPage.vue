      ...
      <div id="register-page" style="margin: 20px">
        ...
        >
          <template v-slot:title>
            ...
            >
              <img
                ...
                class="mr-2"
              />
              <span class="mr-6`" style="font-size: 38px; padding-bottom: 2px">
          ...
          <v-card-text>
            ...
            <router-link
              to="/auth/login"
              style="color: blue; font-size: 16px; text-decoration: underline"
            >
              {{ $t('register.login') }}
            </router-link>
          </v-card-text>
          ...
          >
            <v-container style="align-items: center" class="ml-6 mr-5">
              <v-text-field
                ...
                width="90%"
                :rules="[rules.required, rules.format_check_name]"
                :counter="20"
                maxlengh="20"
                dense
              >
              ...
              <v-text-field
                ...
                :rules="[rules.required, rules.format_check_email]"
                width="90%"
              >
              </v-text-field>
              ...
              <v-text-field
                ...
                :rules="[rules.required, rules.format_check_password]"
                width="90%"
              />
              <v-text-field
            ...
            <div id="Terms-of-Service">
              ...
              >
                <div class="ml-5 mr-5 mb-2" style="text-align: left">
                  {{ $t('register.readTerms') }}
                  <a href="/rules/terms_of_service">{{
                    $t('g.termOfService')
                  }}</a>
                  {{ $t('g.and') }}
                  <a href="/rules/privacy_policy/privacy_protection">{{
                    $t('g.privacyPolicy')
                  }}</a>
                </div>
            ...
            <v-card-actions>
              <v-container fluid ma="0">
                <v-row>
                  <v-btn class="bg-secondary text-white" width="100px">
